...
{
    public function createNota($titulo, $descripcion, $archivado,$fijado, $request)
    {
        $nota = new Notas;
        $nota->titulo_nota = $request->titulo_nota;
        $nota->descripcion_nota = $request->descripcion_nota;
        $nota->archivado = $request->archivado === 'true';
        $nota->fijado = $request->fijado === 'true';
        $nota->save();
        return $nota;
    }

    public function editNote($titulo, $descripcion, $archivado, $fijado, $request, $nota)
    {
        $nota->titulo_nota = $request->titulo_nota;
        $nota->descripcion_nota = $request->descripcion_nota;
        $nota->archivado = $request->archivado === 'true';
    ...
    public function doArchivedNote($request, $nota)
    {
        ...
        $fijado = ($request->fijado === 'true') ? true : false;
