...
class NotasController extends Controller
{
  ...
  public function store(StorePostRequest  $request,  NotasRepository $notasRepository)
  {
    ...
    $nota = $notasRepository->createNota($validatedData['titulo_nota'], $validatedData['descripcion_nota'], $validatedData['archivado'],$validatedData['fijado'], $request);
    return $nota;
  }
  ...
  {
    $nota = Notas::find($notas);
    $nota = $notasRepository->editNote(['titulo_nota'], ['descripcion_nota'],['archivado'],['fijado'] ,$request, $nota);
    return $nota;
  }
